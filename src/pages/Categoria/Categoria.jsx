...
const Categoria = () => {
  ...
  const { categoria, itens } = useSelector(state => {
    // ao invé de retornar diretamente nos retornams um objeto
    
    // ele espera o state.busca e o 'i' quer dizer que ele é case sensitive
    ...
    return {
      ...
      // vamos filtar pela categoria ser igual a categoria e por ter o mesmo nome
      itens: state.itens.filter((item) => item.categoria === nomeCategoria && item.titulo.match(regex)), //retornará apenas os itens da categoria clicada (nomeCategoria)
    }
  });
