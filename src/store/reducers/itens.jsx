...
// para criar um pequeno pedaço do store precisamos do 'createSlice'
const itensSlice = createSlice({
  // tendo que passar o nome e o estado inicial
  name: 'itens',
  initialState,
  // caso o nome da variável acima com as categorias seja "initialState", podemos apenas passar o nome "initialState" e não "initialState: initialState"
  // initialState

  // criando um reducer que depois exportaremos como action (((((não entendi)))))
    // sendo o state o estado e o params............
  reducers: {
    // como não iremos precisar do type, pegamos o playload direto
    mudarFavorito: (state, {payload}) => {
      // console.log('state', state);
      // console.log('params', params);

      // o state daqui não é o state do store (este que tá escrito acima) e sim o do reducer, já sendo o item
...
// para que tenha acesso a action, temos que exportar ela
